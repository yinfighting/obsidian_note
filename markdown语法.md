...
#### 调整图片大小
比如，将上面的实例图片调整为1000像素宽
```md
![Engelbart|1000](https://history-computer.com/ModernComputer/Basis/images/Engelbart.jpg)
```
![Engelbart|1000](https://history-computer.com/ModernComputer/Basis/images/Engelbart.jpg)
...
| 标题               |内容                |
|-----|------  ------------------------- |
|xxxx|cccddddddddddddddddddddddddddddcc|
|cccccc|ddddd|
...
脚注的用法很简单，只需要在段落中需要插入脚注的地方标注一个符号，再在段落后对这个符号进行解释即可。比如这是一个简单的脚注，[^122] 这是一个长一些的脚注。[^长脚注]
