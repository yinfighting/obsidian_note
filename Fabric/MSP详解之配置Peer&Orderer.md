![](https://pic2.zhimg.com/80/v2-f4771bebeec0e892e8635930f3312cd5_720w.jpg)
...
![](https://pic3.zhimg.com/80/v2-4822ce17bca832cb057b5d8a523c1ce2_720w.jpg)


## **二、目录解析**
- ##### **所有的tls ca证书都相同, 所有的admin证书都相同, 所有的ca证书都相同**
...
│   │   ├── msp # msp相关证书   
│   │   │   ├── admincerts  # 组织管理员的身份验证证书。Peer将基于这些证书来认证交易签署者是否为管理员身份。 与上面msp中admincerts一样
│   │   │   │   └── Admin@org1.example.com-cert.pem
│   │   │   ├── cacerts     # 存放组织的根证书   与上面msp中cacerts一样
│   │   │   │   └── ca.org1.example.com-cert.pem
...
└── users    # 存放属于该组织的用户的实体
    ...
    │   ├── msp # msp相关证书
    │   │   ├── admincerts     # 组织根证书作为管理员身份验证证书 与上面的一样
    │   │   │   └── Admin@org1.example.com-cert.pem
    │   │   ├── cacerts        # 存放组织的根证书 与上面的一样
    │   │   │   └── ca.org1.example.com-cert.pem
